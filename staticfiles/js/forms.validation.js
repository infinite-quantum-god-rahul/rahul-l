...
(function(){
  ...
  function initializeDatePickers(){ 
    ...
    if (typeof flatpickr!=="undefined") {
      ...
      console.log(`🗓️ Found ${dateFields.length} date fields:`, dateFields);
      if (dateFields.length > 0) {
        flatpickr(".date-field", {
          ...
          altInput: false,
          onOpen: function() {
            console.log('🗓️ Date picker opened');
          }
        });
        console.log('✅ Date pickers initialized successfully');
      }
    } else {
      console.warn('⚠️ Flatpickr not loaded - calendar functionality unavailable');
    }
  }
